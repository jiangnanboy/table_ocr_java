...
import com.detection.OcrDetection;
import com.recognition.OcrRecognition;
import com.utils.common.EngineConstant;
...
public class OcrApp {
     ...
     * @throws TranslateException
     */
    public List<TextListBox> ocrImage(Image image) throws TranslateException {
     ...
     * @throws TranslateException
     */
    public List<TextListBox> ocrImage(Image image, int maxSideLen) throws TranslateException {
        LOGGER.info("Load image -> " + "；height: " + image.getHeight() + "；width: " + image.getWidth());
        if(-1 != maxSideLen) {
            image = ImageUtils.imageResize(image, maxSideLen);
            LOGGER.info("Resize image -> " + "；height: " + image.getHeight() + "；width: " + image.getWidth());
